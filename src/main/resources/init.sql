...
INSERT INTO schedule (id, member_id, title, start_date_time, end_date_time, place)
VALUES (31, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Early Morning Meeting', '2024-09-15 00:00:00',
        '2024-09-15 10:30:00', 'Conference Room A'),
       (32, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Day-long Workshop', '2024-09-20 00:00:00', '2024-09-20 18:00:00',
        'Training Center'),
       (33, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Overnight Project Kickoff', '2024-09-25 00:00:00',
        '2024-09-26 08:00:00', 'Main Office');

-- 종료 시간이 23:59:59인 경우 (3개)
INSERT INTO schedule (id, member_id, title, start_date_time, end_date_time, place)
VALUES (34, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Late Night Coding Session', '2024-09-18 20:00:00',
        '2024-09-18 23:59:59', 'Development Lab'),
       (35, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'End-of-Month Review', '2024-09-30 14:00:00', '2024-09-30 23:59:59',
        'Board Room'),
       (36, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'International Conference Call', '2024-09-22 22:00:00',
        '2024-09-22 23:59:59', 'Virtual Meeting Room');

-- 9월 1일부터 30일 중 랜덤으로 5개의 일정 추가
INSERT INTO schedule (id, member_id, title, start_date_time, end_date_time, place)
VALUES (37, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Quarterly Planning', '2024-09-03 09:30:00', '2024-09-03 12:30:00',
        'Strategy Room'),
       (38, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Client Lunch Meeting', '2024-09-17 12:00:00',
        '2024-09-17 14:00:00', 'Fancy Restaurant'),
       (39, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Team Building Exercise', '2024-09-24 14:00:00',
        '2024-09-24 17:00:00', 'City Park'),
       (40, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Product Development Review', '2024-09-11 10:00:00',
        '2024-09-11 11:30:00', 'Innovation Lab'),
       (41, 'a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8', 'Annual Performance Evaluation', '2024-09-29 13:00:00',
        '2024-09-29 16:00:00', 'HR Office');
...
INSERT INTO schedule (id, member_id, title, start_date_time, end_date_time, place)
VALUES (47, 'park', '8월 1일부터 10월 3일까지인 일정', '2024-08-01 09:30:00', '2024-10-03 12:30:00', '서울');

INSERT INTO schedule (id, member_id, title, start_date_time, end_date_time, place)
VALUES (48, 'park', '9월 1일부터 9월 30일까지인 일정', '2024-09-01 09:30:00', '2024-09-30 12:30:00', '판교');

INSERT INTO schedule (id, member_id, title, start_date_time, end_date_time)
VALUES (49, 'park', '9월 1일부터 10월 3일까지인 일정', '2024-09-01 09:30:00', '2024-10-03 12:30:00');